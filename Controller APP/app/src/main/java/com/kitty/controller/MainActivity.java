...
public class MainActivity extends AppCompatActivity {
    int speed = 5;
    private final String DEVICE_ADDRESS = "00:18:91:D7:F5:8A"; //MAC Address of Bluetooth Module
    ...
    Button forward_btn, forward_left_btn, forward_right_btn, reverse_btn,cruise, reverse_left_btn, reverse_right_btn, bluetooth_connect_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cruise = (Button)findViewById(R.id.button);
        ...
        SeekBar simpleSeekBar;
        {
            ...
            simpleSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onStopTrackingTouch(SeekBar seekBar) {
                    Toast.makeText(MainActivity.this, "Speed is :" + progressChangedValue,
                            Toast.LENGTH_SHORT).show();
                    if(progressChangedValue!=10)
                    command = String.valueOf(progressChangedValue);
                    else
                    command = "M";
                    try
                    {
        ...
        cruise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cruise.getText().toString().equals("Enable Adaptive Cruise control")){
                command = "C";
                    cruise.setText("Disable Adaptive Cruise control");
                try
                {
                    outputStream.write(command.getBytes());
                }
                catch (IOException e)
                {
                    ...
                    command = "A";
                    cruise.setText("Enable Adaptive Cruise control");
                    try
                    {
                        outputStream.write(command.getBytes());
                    }
